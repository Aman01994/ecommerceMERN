    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='group relative'>
              <Link onClick={()=>token ? null: navigate("/login") } to="/login"><img src={assets.profile_icon} className='w-5 cursor-pointer' alt="" /></Link> 
              {/* {------------------------- Drop Down ------------------------} */}
          ...
          <Link to="/cart" className="relative">
            ...
            {/* <p className='bg-black absolute w-4 bottom-[-5px] text-white text-[8px] rounded-full leading-4 aspect-square text-center right-[-5px]'>11</p> */}
          </Link>
